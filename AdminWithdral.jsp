...
//	{
	...
	PreparedStatement pst=conn.prepareStatement("update register_admin set balance='"+upval+"' where username='"+username+"'");
	if(n<0){
		RequestDispatcher d=request.getRequestDispatcher("AdminWithdral.jsp");
