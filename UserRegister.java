	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String balance="1000";
	     ...
	     try {
	        ...
	        PreparedStatement pst=con.prepareStatement("insert into register_customer(username,password,name,adharno,panno,accountno,balance) values('"+username+"','"+password+"','"+name+"','"+adharno+"','"+panno+"','"+accountno+"','"+balance+"')");
	       ...
	       else
	       {
	    	   ...
	    	   RequestDispatcher d=request.getRequestDispatcher("Register.html");
	    	   d.forward(request, response);
	       }
	       con.close();
	     }catch(Exception e) {
